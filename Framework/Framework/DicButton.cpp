...
void DicButton::Update() {
	...
	if (playdata->nowdic != lastdic)
	{
		...
		if (lastdic == 1) {
			s.Destroy(con);
			con = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\개념.png", 80, 50, 1));
			con->transform->SetPosition(145, 140);
		}
		if (lastdic == 2) {
			s.Destroy(nat);
			nat = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\자연.png", 80, 50, 2));
			nat->transform->SetPosition(345, 140);
		}
		if (lastdic == 3) {
			s.Destroy(hum);
			hum = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\인공.png", 80, 50, 3));
			hum->transform->SetPosition(545, 140);
		}
		if (lastdic == 4) {
			s.Destroy(fan);
			fan = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\환상.png", 80, 50, 4));
			fan->transform->SetPosition(745, 140);
		}
		if (lastdic == 5) {
			s.Destroy(pow);
			pow = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\힘.png", 80, 50, 5));
			pow->transform->SetPosition(945, 140);
		}
		if (lastdic == 6) {
			s.Destroy(no);
			no = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\무계열.png", 80, 50, 6));
			no->transform->SetPosition(1130, 140);
		}
		lastdic = playdata->nowdic;
		if (lastdic == 1) {
			s.Destroy(con);
			con = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\개념s.png", 80, 50, 1));
		...
		if (lastdic == 2) {
			s.Destroy(nat);
			nat = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\자연s.png", 80, 50, 2));
			onselect = (GameObject*)s.PushBackGameObject(new GameObject(L"resources\\onselect.png"));
			nat->transform->SetPosition(345, 140);
		...
		if (lastdic == 3) {
			s.Destroy(hum);
			hum = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\인공s.png", 80, 50, 3));
			onselect = (GameObject*)s.PushBackGameObject(new GameObject(L"resources\\onselect.png"));
			hum->transform->SetPosition(545, 140);
		...
		if (lastdic == 4) {
			s.Destroy(fan);
			fan = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\환상s.png", 80, 50, 4));
			onselect = (GameObject*)s.PushBackGameObject(new GameObject(L"resources\\onselect.png"));
			fan->transform->SetPosition(745, 140);
		...
		if (lastdic == 5) {
			s.Destroy(pow);
			pow = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\힘s.png", 80, 50, 5));
			onselect = (GameObject*)s.PushBackGameObject(new GameObject(L"resources\\onselect.png"));
			pow->transform->SetPosition(945, 140);
		...
		if (lastdic == 6) {
			s.Destroy(no);
			no = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\무계열s.png", 100, 50, 6));
			onselect = (GameObject*)s.PushBackGameObject(new GameObject(L"resources\\onselect.png"));
			no->transform->SetPosition(1130, 140);
...
void DicButton::OnClick()
{
	...
	if (playdata->showdic) {
		...
		hum = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\인공.png", 80, 50, 3));
		fan = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\환상.png", 80, 50, 4));
		pow = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\힘.png", 60, 50, 5));
		no = (conbutton*)s.PushBackGameObject(new conbutton(L"resources\\무계열.png", 100, 50, 6));
